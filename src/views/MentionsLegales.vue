	...
	<div class="outsider">
		...
		<div class="container">
			<p>
				...
				la confiance dans l’économie numérique, les responsables du présent site
				internet
				<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
				>
				sont :
			</p>

			<p class="orange bold-600">Editeur du Site :</p>
			<p>Nom : Oliveira Melo</p>
			<p>Prénom : Juliana</p>
			<p>Mansonville</p>
			<p>Email : julianameo@gmail.com</p>
			<p>
				Site Web :
				<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
			...
			<p class="orange bold-600">Hébergement :</p>
			<p>Hébergeur : vercel</p>
			<p>United Kingdom</p>
			<p>
				Site Web : <a href="http://https://vercel.com/">https://vercel.com/</a>
			</p>
			<p class="orange bold-600">Développement :</p>
			<p>Juliana Oliveira Melo</p>
			<p>Adresse : Mansonville</p>
			<p>
				Site Web :
				<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
			...
			<p class="orange bold-600">Conditions d’utilisation :</p>
			<p>
				Ce site (<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
				>) est proposé en différents langages web (HTML, HTML5, Javascript, CSS,
			...
			<p>
				<span class="hotpink">Oliveira Melo Juliana</span> met en œuvre tous les
				moyens dont elle dispose, pour assurer une information fiable et une
				mise à jour fiable de ses sites internet. Toutefois, des erreurs ou
				omissions peuvent survenir. L'internaute devra donc s'assurer de
				l'exactitude des informations auprès de
				<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
			...
			<p>
				<span class="orange">Cookies</span> : Le site
				<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
				>
			...
			<p>
				<span class="orange">Liens hypertextes :</span> Les sites internet de
				peuvent offrir des liens vers d’autres sites internet ou d’autres
				ressources disponibles sur Internet. Oliveira Melo Juliana ne dispose
				d'aucun moyen pour contrôler les sites en connexion avec ses sites
				internet, ne répond pas de la disponibilité de tels sites et sources
				...
				éléments. Les risques liés à cette utilisation incombent pleinement à
			...
			<p>
				...
				l'autorisation expresse et préalable de Oliveira Melo Juliana.
			</p>

			<p>
				Dans l'hypothèse où un utilisateur ou visiteur souhaiterait mettre en
				place un hyperlien en direction d’un des sites internet de Oliveira Melo
				Juliana, il lui appartiendra d'adresser un email accessible sur le site
				afin de formuler sa demande de mise en place d'un hyperlien. Oliveira
				Melo Juliana se réserve le droit d’accepter ou de refuser un hyperlien
				sans avoir à en justifier sa décision.
			</p>
			<p class="orange bold-600">Services fournis :</p>
			<p>
				L'ensemble des activités ainsi que ses informations sont présentés sur
				notre site
				<a href="http://https://portfolio-psi-gilt-96.vercel.app/"
					>https://portfolio-psi-gilt-96.vercel.app/</a
				>.
			...
			<p>
				<span class="hotpink">Oliveira Melo Juliana</span> s’efforce de fournir
				sur le site https://portfolio-psi-gilt-96.vercel.app/ des informations
				...
				https://portfolio-psi-gilt-96.vercel.app/<span style="color: #000000;"
					><b> </b></span
				>sont données à titre indicatif, et sont susceptibles de changer ou
				d’évoluer sans préavis.
			</p>
			<p class="orange bold-600">Limitation contractuelles sur les données :</p>
			<p>
				...
				<a href="mailto:julianameo@gmail.com">ici</a>, en décrivant le problème
			...
			<p>
				...
				<span class="lightOpacity"
					...
					navigateur de dernière génération mis-à-jour</span
				>
			</p>
			...
			<p>
				...
				Internet ne sauraient engager la responsabilité de Oliveira Melo
				Juliana.
			</p>
			<p class="orange bold-600">Propriété intellectuelle :</p>
			<p>
				...
				forme sont la propriété exclusive de la Oliveira Melo Juliana à
			...
			<p>
				...
				Oliveira Melo Juliana. Cette représentation ou reproduction, par quelque
				procédé que ce soit, constitue une contrefaçon sanctionnée par les
				articles L.335-2 et suivants du Code de la propriété intellectuelle. Le
			...
			<p class="orange bold-600">Déclaration à la CNIL :</p>
			<p>
				...
				l'informatique et des libertés (<a href="http://www.cnil.fr/"
					>www.cnil.fr</a
				>).
			</p>
			<p class="orange bold-600">Litiges :</p>
			<p>
				...
				seront de la compétence exclusive des tribunaux. La langue de référence,
				pour le règlement de contentieux éventuels, est le français.
			</p>

			<p class="orange bold-600">Données personnelles :</p>
			<p>
			...
			<p>
				...
				site, notamment celui de solliciter des renseignements sur nos
				activités, ou de recevoir les lettres d’information.
			</p>
			...
			<p>
				...
				d'accès. De telles informations sont utilisées exclusivement à des fins
				de statistiques internes, de manière à améliorer la qualité des services
