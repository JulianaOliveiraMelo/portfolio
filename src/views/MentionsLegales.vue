<template>
	<div class="outsider">
		...
		<p>
			<span style="color: #323333;">Oliveira Melo Juliana</span> met en œuvre
			tous les moyens dont elle dispose, pour assurer une information fiable et
			une mise à jour fiable de ses sites internet. Toutefois, des erreurs ou
			omissions peuvent survenir. L'internaute devra donc s'assurer de
			l'exactitude des informations auprès de , et signaler toutes modifications
			du site qu'il jugerait utile. n'est en aucun cas responsable de
		...
		<p>
			<b>Liens hypertextes :</b> Les sites internet de peuvent offrir des liens
			vers d’autres sites internet ou d’autres ressources disponibles sur
			Internet. Oliveira Melo Juliana ne dispose d'aucun moyen pour contrôler
			les sites en connexion avec ses sites internet. ne répond pas de la
		...
		<p>
			...
			afin de formuler sa demande de mise en place d'un hyperlien. Oliveira Melo
			Juliana se réserve le droit d’accepter ou de refuser un hyperlien sans
		...
		<p style="color: #323333;">
			Oliveira Melo Juliana s’efforce de fournir sur le site
			https://portfolio-psi-gilt-96.vercel.app/ des informations aussi précises
		...
		<p style="color: #b51a00;">
			<span style="color: rgb(0, 0, 0);"
				><b>Limitation contractuelles sur les données : </b></span
			>
		</p>
		<p>
			...
			bien vouloir le signaler par email, à l’adresse julianameo@gmail.com, en
		...
		<p>
			...
			<span style="color: #323333;"
				...
				dernière génération mis-à-jour</span
			>
		</p>
		...
		<p>
			...
			sauraient engager la responsabilité de Oliveira Melo Juliana.
		</p>
		<p style="color: #b51a00;">
			<span style="color: rgb(0, 0, 0);"
		...
		<p>
			...
			interdite sans l'accord exprès par écrit de Oliveira Melo Juliana. Cette
		...
		<p>
			...
			solliciter des renseignements sur nos activités, ou de recevoir les
