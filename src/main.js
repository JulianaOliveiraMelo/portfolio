					...
					data: {
						...
						training: [
							...
							},
							{
								...
								linkText:
									"Voir les projets réalisées au sein de O'Clock - gitHub",
								linkString:
							...
							},
							{
								...
								linkString:
									'https://dyma.fr/developer/5f81b6b44b3326259b4e48dc',
								diplomes: [
									{
						...
						work: [
							...
							},
							{
								...
								image: {
									...
									description:
										'Build a Technical Documentation Page screenshot',
							...
							},
							{
								...
								image: {
									...
									description: 'Invader',
									link:
										'https://challenge-invader.vercel.app/html/invader.html',
								},
								text:
									'<p>Objectif: Utilisation des valeurs acquises dans la journée, en classe, pour coder un jeux.</p><ul><li>HTML</li><li>CSS</li><li>JavaScript</li></ul><p>Projet Solo</p>',
							},
							...
							},
							{
								...
								image: {
									...
									description:
										'image du site Hôtel Restaurant Le Continental ⭐⭐⭐',
							...
							},
							{
								...
								school: {
									...
									link:
										'https://www.frontendmentor.io/profile/JulianaOliveiraMelo',
								},
								icons: {
									HTML: 'icons8-html-5-50.png',
									CSS: 'icons8-css3-50.png',
						...
						experience: [
							...
							},
							{
								...
								businessLink:
									'http://www.savoie.cci.fr/actualite/1955/137-auto-entrepreneur-le-portail-officiel-et-le-nouveau-guide-de-juin-2020.htm',
